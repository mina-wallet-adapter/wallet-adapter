...
<Image src={addAssetPrefix("/assets/welcome_modal.png")} alt="Welcome Modal" width={300} height={358} />
...
<Image src={addAssetPrefix("/assets/select_modal.png")} alt="Select Modal" width={300} height={293} />
